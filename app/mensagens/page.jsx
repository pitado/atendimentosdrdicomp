...
setBuscandoCnpj(true);
  ...
  function selecionarChatAberto(chat) {
      ...
      <div className="container">
        <div className="config chats-abertos">
          <div className="campo" style={{ flexBasis: '100%' }}>
            <label>Atendimentos abertos na Umbler</label>
            <div className="linha">
              <button className="btn-azul" onClick={buscarChatsAbertos} disabled={carregandoChats} type="button">
                {carregandoChats ? 'Buscando...' : 'Buscar atendimentos abertos'}
              </button>
            </div>
